...
# 图片路径
IMAGE_PATH = Path(__file__).parent.parent.parent / "resrouces" / "sign_res"
# 字体路径
FONT_PATH = Path(__file__).parent.parent.parent/ "resrouces" / "fonts"
...
def get_img_hash(image_file: Union[str, Path]):
    """
    说明：
        获取图片的hash值
    参数：
